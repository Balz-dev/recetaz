...
interface DetalleRecetaViewProps {
    recetaId: string;
}

export function DetalleRecetaView({ recetaId }: DetalleRecetaViewProps) {
    ...
    if (!receta || !paciente) {
        return (
            <div className="text-center py-10 space-y-4">
                <h3 className="text-lg font-semibold text-red-600">Receta no encontrada (Offline)</h3>
                <Link href="/recetas">
